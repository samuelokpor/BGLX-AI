...
this tricycle it is a genuine failure. The vehicle is 1.24m long and 0.57m
...
VEHICLE_WIDTH = 0.57          # conservative concept footprint including sensors
VEHICLE_LENGTH = 1.24         # -0.20 to 1.04 from base_footprint
MIRROR_CLEARANCE = 0.15       # each side: handlebars, cargo rails, wobble
TURN_AROUND_SPACE = 4.1       # retained conservative turn-around allowance; not a measured diameter

# A gap must exceed this to be called comfortable rather than tight.
COMFORTABLE = VEHICLE_WIDTH + 2 * MIRROR_CLEARANCE + 0.40    # 1.27m
MINIMUM = VEHICLE_WIDTH + 2 * MIRROR_CLEARANCE               # 0.87m
